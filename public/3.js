    ...
    showNoActas: function showNoActas() {
      ...
      this.$swal({
        ...
        didOpen: function didOpen() {
          ...
          var minutos = _this4.$swal.getHtmlContainer().querySelector('b');

          var segundos = _this4.$swal.getHtmlContainer().querySelector('strong');
                ...
                [
                  _c("div", { staticClass: "grid grid-cols-2 gap-4" }, [
                    ...
                    _c("div", { staticClass: "min-w-[50%] pr-2" }, [
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "container mx-auto pb-3" }, [
                        _c(
                          "table",
                          ...
                          [
                            ...
                            _c("tbody", [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "bg-white border-blanco dark:bg-blanco dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 hover:bg-blue-100 dark:hover:text-negro"
                                },
                                [
                                  _c(
                                    "td",
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "bg-white border-blanco dark:bg-blanco dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 hover:bg-blue-100 dark:hover:text-blanco"
                                },
                                [
                                  _c(
                                    "td",
                          ...
                          _vm.acta.id
                            ? [
                                _c(
                                  ...
                                  {
                                    class:
                                      "flex justify-center w-full border-solid border border-negro rounded-xl bg-negro hover:bg-plomo" +
                                      (_vm.processing
                                        ? " bg-plomo"
                                        : " bg-negro"),
                                    attrs: {
