                ...
                <form @submit.prevent="addActa" class="w-full">
                    <div class="flex p-4">
                        ...
                        <div class="min-w-[50%] pr-2" v-if="recintos.length>0">
                            ...
                            <div class="bg-white shadow-md mb-4 rounded">
                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="multiple_files">Celeccionar la imagen de una acta</label>
                        ...
                        <div class="min-w-[50%] pl-2 flex items-center">
                            ...
                            <figure class="max-w-lg">
                                <img class="h-auto max-w-full rounded-lg" :src="image ? image :'no-imagen-acta.jpg'" alt="Imagen de la Acta">
