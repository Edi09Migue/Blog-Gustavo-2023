...
<div class="grid place-items-center h-screen box-main">
    <div class="max-w-lg sm:w-[90%] md:w-[40%] lg:w-[25%] mx-auto h=1/2 shadow-xl rounded my-8">
        <div class=" bg-[#21212196] box-login">
            <div class="text-center text-blanco py-4 uppercase text-xl flex justify-center">
                <!-- <strong>Control Electoral Ec</strong> -->
                <img src="/images/login/ceec.png" class="sm:w-1/2 md:1/2" alt="Control Electoral">
            </div>
            <div class="pt-2 pb-1">
        ...
        <div class="text-center text-blanco py-1 uppercase text-xl flex justify-center">
            <img src="/images/login/solidariamente.png" class="sm:w-1/2 md:1/2" alt="Control Electoral">
        </div>
    </div>
</div>
</template>
