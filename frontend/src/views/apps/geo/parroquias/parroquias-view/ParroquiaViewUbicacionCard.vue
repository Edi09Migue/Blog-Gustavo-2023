   ...
   'l-wms-tile-layer': LWMSTileLayer,
    ...
    data() {
        return {
            cantonesList: [],
            url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
            zoom: this.parroquiaData.zoom,
            token:'mapbox token',
            imperial: false,
            center: [this.parroquiaData.lat, this.parroquiaData.lng],
            bounds:[
                [this.parroquiaData.miny, this.parroquiaData.minx],
                [this.parroquiaData.maxy, this.parroquiaData.maxx],
            ],
            rectangle:{
