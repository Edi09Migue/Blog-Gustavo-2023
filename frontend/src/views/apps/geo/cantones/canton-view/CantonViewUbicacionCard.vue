   ...
   'l-wms-tile-layer': LWMSTileLayer,
    ...
    data() {
        return {
            cantonesList: [],
            url: "https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",
            zoom: this.cantonData.zoom,
            token:'mapbox token',
            imperial: false,
            center: [this.cantonData.lat, this.cantonData.lng],
            bounds:[
                [this.cantonData.miny, this.cantonData.minx],
                [this.cantonData.maxy, this.cantonData.maxx],
            ],
            rectangle:{
