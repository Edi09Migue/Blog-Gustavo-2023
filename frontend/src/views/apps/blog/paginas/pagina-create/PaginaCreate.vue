            ...
            <!-- <b-col md="6">
              ...
              >
                ...
                >
                  <b-form-input
                    id="slug"
                    v-model="paginaData.slug"
                    :maxlength="255"
                    :state="getValidationState(validationContext)"
                    trim
                    placeholder="Ej: titulo-c-2"
                  />
                    <b-form-invalid-feedback>
                      {{ validationContext.errors[0] }}
                    </b-form-invalid-feedback>
...
import usePaginaCreate from './usePaginaCreate'
...
export default {
  ...
  setup() {
    ...
    const onSubmit = () => {
        store.dispatch("blog-paginas/addPagina", paginaData.value).then((response) => {
