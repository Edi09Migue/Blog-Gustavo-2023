            ...
            >
                <b-row>
                        ...
                        >
                            ...
                            >
                                <b-form-checkbox
                                    ...
                                    v-model="
                                        configDataLocal.notificaciones_mail
                                    "
                                    :state="
                    ...
                    <b-col cols="12" md="6">
                        <validation-provider
                            #default="validationContext"
                            name="notificaciones_websocket"
                            rules="required|max:255"
                        >
                            <b-form-group
                                :label="$t('Mail Notifications')"
                                label-for="notificaciones_websocket"
                            >
                                <b-form-checkbox
                                    id="notificaciones_websocket"
                                    v-model="
                                        configDataLocal.notificaciones_websocket
                                    "
                                    :state="
                                        getValidationState(validationContext)
                                    "
...
export default {
    ...
    mounted() {
        this.configDataLocal.notificaciones_mail = this.findValue(
            "notificaciones_mail"
        );
        this.configDataLocal.notificaciones_websocket = this.findValue(
            "notificaciones_websocket"
        );
    },
    props: {
        settingsData: {
    ...
    setup(props) {
        ...
        const onSubmit = () => {
            store
                .dispatch("app-setting/updateConfigs", configDataLocal)
                .then(response => {
