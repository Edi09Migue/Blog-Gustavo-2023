                ...
                <b-row class="mt-2">
                    <b-col cols="12" md="6">
                        <validation-provider
                            ...
                            rules=""
                        >
                            <b-form-group label="Parroquia" label-for="parroquia">
                                <v-select
                    ...
                    <b-col cols="12" md="6">
                        <validation-provider
                            ...
                            rules=""
                        >
                            <b-form-group label="Candidatos" label-for="candidato">
                                <v-select
                                    v-model="filtros.candidatos"
                                    label="name"
                                    multiple
        ...
        validationForm() {
            this.$refs.simpleRules.validate().then(success => {
                if (success) {
                    ...
                    store
                        .dispatch("app-inscritos/generarReportes", this.filtros)
                        .then(response => {
