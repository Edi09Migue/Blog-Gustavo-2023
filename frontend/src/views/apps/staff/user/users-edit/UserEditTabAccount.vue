        ...
        <b-media class="mb-2">
            <template #aside>
                <b-avatar
                    ref="previewEl"
                    :src="profileFile"
                    :text="avatarText(userDataLocal.name)"
                    :variant="
                        `light-${resolveUserRoleVariant(userDataLocal.role)}`
                    "
                    size="90px"
                    rounded
                />
                ...
                <b-row>
                    ...
                    <b-col cols="12" md="4">
                        ...
                        >
                            <b-form-input
                                id="empresa"
                                v-model="userDataLocal.user_info.empresa"
...
export default {
    ...
    methods: {
        validateRemoteField(field, value) {
            return store
                .dispatch("app-user/validateUnique", {
                    field: field,
                    value: value
                })
                .then(response => {
    ...
    setup(props) {
        ...
        const onSubmit = () => {
            store
                .dispatch("app-user/updateUser", userDataLocal)
                .then(response => {
